...
def trigger_simple_task(request):
    simple_task.delay()  # Call Celery task asynchronously
    return JsonResponse({"message": "Simple task triggered!"})

# View to trigger send task reminders
def trigger_send_task_reminders(request):
    send_task_reminders.delay()  # Call Celery task asynchronously
    return JsonResponse({"message": "Task reminders triggered!"})
